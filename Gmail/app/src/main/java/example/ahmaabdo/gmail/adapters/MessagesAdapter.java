package example.ahmaabdo.gmail.adapters;
...
import example.ahmaabdo.gmail.R;
import example.ahmaabdo.gmail.helper.CircleTransform;
import example.ahmaabdo.gmail.helper.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        // make the text bold depending on read status. If the message is unread, it will be kept in bold.
        applyReadStatus(holder, message);

        //Displays the star icon in yellow color if the message is marked as important.
        applyImportant(holder, message);

        // performs the flip animation on thumbnail icon.
        applyIconAnimation(holder, position);

        // Displays the thumbnail icon profile picture / background in circular fashion.
